# 2022.07 TIL
> - FastCampus Megabyte School 프론트엔드 과정 수료.
> - C언어 독학
> - 주요 프로젝트 => [[Final Project]](https://github.com/Sweet-Pumpkin/STFE3-4_Final_Project_9TEAM), [[React 그림판 만들기]](https://github.com/Sweet-Pumpkin/react-paint-app)
...
1. React 그림판 만들기
  - 스타일 수정
2. Megabyte School 멘토링

## 2022.07.28 목요일 TIL
1. FastCampus 채용연계과정 준비
  - 자기소개서, 이력서, 포트폴리오 작성

## 2022.07.27 금요일 TIL
1. FastCampus 채용박람회 참석
2. FastCampus Megabyte School 수료
3. React 그림판 만들기
  - memuBar.jsx 스타일 수정
